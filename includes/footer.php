            ...
            <div class="row">
                    ...
                    <div class="widget pt-0">
                        <div class="vs-widget-about">
                            ...
                            <p class="widget-about-text mb-20">
                                Energistically repurpose client-based odels rather than
                                magnetic sources. Intrinsicly bcks-and-mortar ideas
                                before.
                            </p>
                    ...
                    <div class="widget widget_nav_menu">
                        ...
                        <div class="menu-all-pages-container">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xl-6">
                                    <ul class="menu">
                                        <li><a href="menu.html">Burrito Supreme</a></li>
                ...
                <div class="col-lg-3 col-xl-3 offset-xl-1">
                    <div class="widget">
                        ...
                        <div class="vs-widget-about">
                            <p class="contact-info mb-15">
                                <i class="fal fa-map-marker-alt"></i>70 Pleasant Valley
                                Street, Methuen MA 1844
                            </p>
                            <p class="contact-info mb-15">
                                <i class="fal fa-fax"></i><a href="tel:+65965252561">+659 6525 2561</a>
                            </p>
                            <p class="contact-info mb-15">
                                <i class="fal fa-envelope"></i><a href="mailto:info@example.com">info@example.com</a>
                            </p>
                        </div>
                    </div>
                </div>
